...
export const CheckoutVariants = tv({
  slots: {
    ...
    cartWrapper: 'w-full flex flex-col gap-12 p-4 md:p-6 rounded-md border border-dracula-line bg-dracula-wrapper',
    ...
    cartInput: 'w-full h-full px-4 rounded-md peer border border-dracula-line hover:border-dracula-white focus:border-dracula-cyan bg-transparent focus:outline-none transition ease-in-out duration-300',
    ...
    cartOrderItem: 'flex items-center gap-4 py-4',
    cartImage: 'w-14 hidden md:block',
    cartInfo: 'w-full flex flex-col gap-1',
    cartBetween: 'flex justify-between gap-4',
    cartDescription: 'font-medium text-lg',
