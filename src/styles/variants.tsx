...
export const variantsCheckout = tv({
  slots: {
    ...
    checkLegend: 'text-xl font-medium',
    checkDescript: 'text-sm',
    ...
    checkBtn: 'w-full flex items-center justify-center px-4 h-12 font-medium uppercase rounded-md border border-dracula-cyan bg-transparent hover:bg-dracula-cyan text-dracula-white hover:text-dracula-line transition ease-in-out duration-300',
